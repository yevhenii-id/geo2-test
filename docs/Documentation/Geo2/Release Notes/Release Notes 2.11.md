...
| IBALDEV-4078 | API: Add Planned packages field for consignment entity | Added the Planned packages field for a consignment entity when creating consignments via the API.  See [Consignment (Order)](../API/Consignment%20(Order).md).                                                                                                                                                                                                            |
